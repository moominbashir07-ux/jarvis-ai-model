...
electron_1.contextBridge.exposeInMainWorld('electronAPI', {
    ...
    triggerCommand: (command) => electron_1.ipcRenderer.send('trigger-command', command),
    onCoreStatusUpdate: (callback) => electron_1.ipcRenderer.on('core-status-update', callback),
    onIpcEvent: (callback) => electron_1.ipcRenderer.on('ipc-event', callback),
});
